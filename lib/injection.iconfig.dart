...
import 'package:notes_firebase_ddd_course/application/firestore/products_list/product_list_bloc.dart';
...
void $initGetIt(GetIt g, {String environment}) {
  ...
  g.registerFactory<ProductListBloc>(
      () => ProductListBloc(g<FirebaseAuthFacade>()));
